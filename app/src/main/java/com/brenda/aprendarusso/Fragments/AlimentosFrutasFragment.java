 ...
 */
public class AlimentosFrutasFragment extends Fragment implements View.OnClickListener {
    ...
    public AlimentosFrutasFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_alimentos_frutas, container, false);
